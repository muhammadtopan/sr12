...
@section ('title', 'Daftar Freelance')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Freelance</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <div class="tab-content" id="custom-tabs-two-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="verifikasi" role="tabpanel" aria-labelledby="verifikasi-tab">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach($freelance as $no => $freelances)
                                        <tr>
                            ...
                            <div class="tab-pane fade" id="belum-verifikasi" role="tabpanel" aria-labelledby="belum-verifikasi-tab">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach($freelanceoff as $no => $freeoff)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td class="text-center">
                                                {{ $freeoff->username }}
...
<script>
    ...
    function cekStatus(user_id, ceklis) {
        if (ceklis.checked) {
            ...
            axios.post("{{route('freelance.active')}}", {
                'id': user_id,
            }).then(function(res) {
            ...
            axios.post("{{route('freelance.non_active')}}", {
                'id': user_id,
            }).then(function(res) {
                // console.log(res.data.message)
