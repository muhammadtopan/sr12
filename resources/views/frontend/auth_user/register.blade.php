                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 offset-lg-3 my-5">
                                                <div class="register-form login-form">
                                                    <h3 class="text-light">Daftar Akun Belanjaku</h3>
                                                    ...
                                                    <form action="{{ route('regist-mitra')}}" method="post">
                                                        ...
                                                        <div class="group-input">
                                                            ...
                                                            <div class="custom-file">
                                                                ...
                                                                <label id="selfie_ktp" class="custom-file-label" style="color: #000000 !important" for="inputGroupFile03">Choose file</label>
                                                            </div>
                                                        </div>
                                                        <div class="group-input mb-3">
