                        ...
                        <div class="card-body mada">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-5 ml-4">
                                    <p class="text-light mb-1">1. Kulit Kusam</p>
                                    <p class="text-light mb-1">2. Mata Panda</p>
                                    <p class="text-light mb-1">3. Kulit Berminyak</p>
                                    <p class="text-light mb-1">4. Kulit Bruntus</p>
                                    <p class="text-light mb-1">5. Kulit Berjerawat</p>
                                    <p class="text-light mb-1">6. Noda Bekas</p>
                                </div>
                                <div class="col-md-5 ml-4">
                                    <p class="text-light mb-1">7. Flex Hitam</p>
                                    <p class="text-light mb-1">8. Komedo</p>
                                    <p class="text-light mb-1">9. Kulit Kering</p>
                                    <p class="text-light mb-1">10. Kulit Kendur</p>
                                    <p class="text-light mb-1">11. Kulit Keriput</p>
                                    <p class="text-light mb-1">12. Stretch Mark</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-latest-blog">
                        <div class="latest-text">
                            <a href="#">
                                <h4>SR12 Aman & Halal</h4>
                            </a>
                            <p style="text-align: justify; text-justify: newspaper">Produk-produk yang dipasarkan oleh perusahaan merupakan produk yang telah melalui serangkaian uji dari beberapa saintifis yang bersertifikasi, teruji di Laboratorium Sucofindo dan bebas dari Mercury & Hydroquinon serta telah terdaftar di <a style="display: inline" href="https://cekbpom.pom.go.id//home/produk/nvd8ib9bj21qt81u6g3ip0o966/all/row/10/page/0/order/4/DESC/search/2/sr12" target="_blank"> BPOM RI.</a> </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-latest-blog">
                        <div class="latest-text">
                            <a href="#">
                                <h4>SR12 dan Manfaatnya</h4>
                            </a>
                            <p style="text-align: justify; text-justify: newspaper">Produk SR12 Herbal Skincare memiliki banyak varian yang semuanya memiliki fungsi masing-masing sesuai dengan peruntukannya. Konsultasikan permasalahan yang kamu alami agar kami bisa merekomendasikan produk yang tepat sesuai dengan jenis dan masalah kulitmu.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container blog-details-inner">
            ...
            <div class="blog-post pt-0 mb-0">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 prev-blog mb-4">
                        <div class="pb-pic">
                            <img src="{{asset('frontend/img/about/3.jpg')}}" alt="">
                        </div>
                        <div class="pb-text">
                    ...
                    <div class="col-lg-4 col-md-6 prev-blog mb-4">
                        <div class="pb-pic">
                            <img src="{{asset('frontend/img/about/4.jpg')}}" alt="">
                        </div>
                        <div class="pb-text">
                    ...
                    <div class="col-lg-4 col-md-6 prev-blog mb-4">
                        <div class="pb-pic">
                            <img src="{{asset('frontend/img/about/6.jpg')}}" alt="">
                        </div>
                        <div class="pb-text">
    ...
    <section class="latest-blog spad pt-4 pb-0">
        <div class="container blog-details-inner">
            ...
            <div class="blog-large-pic">
                <img src="{{asset('frontend/img/about/senior.jpg')}}" alt="">
            </div>
        </div>
    </section>
        ...
        <div class="container blog-details-inner">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="col-md-6">
                            <div class="single-latest-blog pl-4">
                                <ul>
                                    ...
                                    <li>
                                        Kamu bisa mendownloadnya dengan mengisi form di berikut ini. 
                                    </li> 
                                    <li>
                    ...
                    <div class="blog-large-pic">
                        <img src="{{asset('frontend/img/about/all_product.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
